...
cred = credentials.Certificate( 'iuh-20083671-firebase-adminsdk-kryfi-13f4d29e28.json')
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "Trường: IUH, Lớp: DHHTTT16B, MSSV: 20083671, Tên: Lương Trung Nguyên", className="header-title"
                )
            ],
            className="header",
        ),
