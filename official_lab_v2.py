...
cred = credentials.Certificate("iuh-20030021-firebase-adminsdk-jd2os-f0f701b570.json")
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20030021').where(u'DEALSIZE', u'==', 'Large').stream())
